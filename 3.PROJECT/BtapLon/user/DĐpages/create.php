            ...
            <div class="row">
                <div class="col-md-12">
                    <form action="" method="POST">
                        <h1 class="create"><span style="color:red">Tạo một câu hỏi</span>
                        <div class="form-group">
                          <label for="txtUserID">Họ tên</label>
                          <input type="text" class="form-control" name="txtUserID" id="txtUserID" value = "" disabled="disabled">
                        </div>
                        <div class="form-group">
                          <label for="txtFirstName">Câu hỏi</label>
                          <input type="text" class="form-control" name="txtFirstName" id="txtFirstName" value = "">
                        </div>
                        <div class="form-group">
                          <label for="txtLastName">Ngày đăng</label>
